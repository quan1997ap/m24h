...
class CreditLoan extends BaseProduct {
  constructor(props) {
    super(props);

    this.state = {
      visit_source: lgd("visit_source", "mf24h"),
      form_product: "credit_loan",
...
function DLoanForm(props) {
  return (
    <div
      className={"block-grey desktop-loan-banner desktop-credit-loan-banner"}
    >
      <div
        ...
        >
          ...
          >
            ...
            <WingBlank size="lg">
              ...
              >
                ĐĂNG KÝ VAY TÍN CHẤP THEO LƯƠNG
              </div>
              <div
                css={{
                  float: "right",
            ...
            >
              ...
              >
                ...
                <div css={{ color: "#939393", fontSize: "14px" }}>
                  MF24H tư vấn gói vay tín chấp theo lương, khoản vay đến 50
                  triệu.
                  <br />
  ...
  return (
    <div className={"signin-form block-grey"}>
      <div className={"banner-image"}>
        <div className={"label"}>ĐĂNG KÝ VAY TÍN CHẤP THEO LƯƠNG</div>
      </div>
      <WhiteSpace size="lg" />
      <WingBlank size="lg">
        <div
        ...
        >
          ...
          >
            ...
            <div css={{ color: "#939393", fontSize: "14px" }}>
              MF24H tư vấn gói vay tín chấp theo lương, <br />
              khoản vay đến 50 triệu.
              <br />
