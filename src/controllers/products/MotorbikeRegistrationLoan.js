...
class MotorbikeRegistrationLoan extends BaseProduct {
  constructor(props) {
    super(props);

    this.state = {
      visit_source: lgd("visit_source", "mf24h"),
      form_product: "motorbike_registration_loan",
...
function DLoanForm(props) {
  return (
    <div
      className={
        "block-grey desktop-loan-banner desktop-motorbike-registration-loan-banner"
      }
    >
      <div
        ...
        >
          ...
          >
            ...
            <WingBlank size="lg">
              ...
              >
                ĐĂNG KÝ VAY THEO ĐĂNG KÝ XE MÁY
              </div>
              <div
                css={{
                  float: "right",
            ...
            >
              ...
              >
                ...
                <div css={{ color: "#939393", fontSize: "14px" }}>
                  MF24H tư vấn gói vay theo đăng ký xe máy (cà vẹt xe), khoản
                  vay đến 50 triệu. <br />
                  Kỳ hạn thanh toán đến 90 ngày. Kỳ thanh toán 10, 15 hoặc 30
                  ngày KH tùy chọn. <br />
  ...
  return (
    <div className={"signin-form block-grey"}>
      <div className={"banner-image"}>
        <div className={"label"}>ĐĂNG KÝ VAY THEO ĐĂNG KÝ XE MÁY</div>
      </div>
      <WhiteSpace size="lg" />
      <WingBlank size="lg">
        <div
        ...
        >
          ...
          >
            ...
            <div css={{ color: "#939393", fontSize: "14px" }}>
              MF24H tư vấn gói vay theo đăng ký xe máy (cà vẹt xe), <br />
              khoản vay đến 50 triệu. <br />
              Kỳ hạn thanh toán đến 90 ngày.
              <br /> Kỳ thanh toán 10, 15 hoặc 30 ngày KH tùy chọn. <br />
              <strong>Chi tiết liên hệ {config.hotline}</strong>
            </div>
            <Flex>
              <Flex.Item>
...
export default MotorbikeRegistrationLoan;
