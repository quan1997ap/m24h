...
class WatchPawn extends BaseProduct {
  constructor(props) {
    super(props);

    this.state = {
      visit_source: lgd("visit_source", "mf24h"),
      form_product: "watch_pawn",
...
function DLoanForm(props) {
  return (
    <div className={"block-grey desktop-loan-banner desktop-watch-pawn-banner"}>
      <div
            ...
            >
              ...
              >
                ...
                <div css={{ color: "#939393", fontSize: "14px" }}>
                  MF24H tư vấn gói vay Cầm đồng hồ với khoản vay đến 30 triệu.{" "}
                  <br />
  ...
  return (
    <div className={"signin-form block-grey"}>
      <div className={"banner-image"}>
        <div className={"label"}>ĐĂNG KÝ CẦM ĐỒNG HỒ</div>
      </div>
      <WhiteSpace size="lg" />
      <WingBlank size="lg">
        <div
        ...
        >
          ...
          >
            ...
            <div css={{ color: "#939393", fontSize: "14px" }}>
              MF24H tư vấn gói vay Cầm đồng hồ <br />
