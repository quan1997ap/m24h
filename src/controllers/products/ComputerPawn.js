...
class ComputerPawn extends BaseProduct {
  constructor(props) {
    super(props);

    this.state = {
      visit_source: lgd("visit_source", "mf24h"),
      form_product: "computer_pawn",
...
function DLoanForm(props) {
  return (
    <div
      className={"block-grey desktop-loan-banner desktop-computer-pawn-banner"}
    >
      <div
            ...
            >
              ...
              >
                ...
                <div css={{ color: "#939393", fontSize: "14px" }}>
                  MF24H tư vấn gói vay Cầm máy tính với khoản vay đến 50 triệu.{" "}
                  <br />
                  Kỳ hạn vay 90 ngày, kỳ thanh toán 10, 15 hoặc 30 ngày KH tùy
                  chọn.
                  <br />
  ...
  return (
    <div className={"signin-form block-grey"}>
      <div className={"banner-image"}>
        <div className={"label"}>ĐĂNG KÝ CẦM MÁY TÍNH</div>
      </div>
      <WhiteSpace size="lg" />
      <WingBlank size="lg">
        <div
        ...
        >
          ...
          >
            ...
            <div css={{ color: "#939393", fontSize: "14px" }}>
              MF24H tư vấn gói vay Cầm máy tính
              <br /> với khoản vay đến 50 triệu. <br />
              Kỳ hạn vay 90 ngày, <br />
