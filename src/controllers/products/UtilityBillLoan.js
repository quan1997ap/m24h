...
class UtilityBillLoan extends BaseProduct {
  constructor(props) {
    super(props);

    this.state = {
      visit_source: lgd("visit_source", "mf24h"),
      form_product: "utility_bill_loan",
...
function DLoanForm(props) {
  return (
    <div
      className={
        "block-grey desktop-loan-banner desktop-utility-bill-loan-banner"
      }
    >
      <div
        ...
        >
          ...
          >
            ...
            <WingBlank size="lg">
              ...
              >
                ĐĂNG KÝ VAY THEO HOÁ ĐƠN ĐIỆN NƯỚC
              </div>
              <div
                css={{
                  float: "right",
            ...
            >
              ...
              >
                ...
                <div css={{ color: "#939393", fontSize: "14px" }}>
                  MF24H tư vấn gói vay theo hoá đơn điện nước, khoản vay đến 50
                  triệu. <br />
  ...
  return (
    <div className={"signin-form block-grey"}>
      <div className={"banner-image"}>
        <div className={"label"}>ĐĂNG KÝ VAY THEO HOÁ ĐƠN ĐIỆN NƯỚC</div>
      </div>
      <WhiteSpace size="lg" />
      <WingBlank size="lg">
        <div
        ...
        >
          ...
          >
            ...
            <div css={{ color: "#939393", fontSize: "14px" }}>
              MF24H tư vấn gói vay theo hoá đơn điện nước,
              <br /> khoản vay đến 50 triệu. <br />
...
export default UtilityBillLoan;
