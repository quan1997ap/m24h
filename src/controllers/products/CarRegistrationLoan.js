...
class CarRegistrationLoan extends BaseProduct {
  constructor(props) {
    super(props);

    this.state = {
      visit_source: lgd("visit_source", "mf24h"),
      form_product: "car_registration_loan",
...
function DLoanForm(props) {
  return (
    <div
      className={
        "block-grey desktop-loan-banner desktop-car-registration-loan-banner"
      }
    >
      <div
        ...
        >
          ...
          >
            ...
            <WingBlank size="lg">
              ...
              >
                ĐĂNG KÝ VAY THEO ĐĂNG KÝ XE Ô TÔ
              </div>
              <div
                css={{
                  float: "right",
            ...
            >
              ...
              >
                ...
                <div css={{ color: "#939393", fontSize: "14px" }}>
                  MF24H tư vấn gói vay nóng theo hình thức <br />
                  cầm đăng ký ô tô (cavet ô tô), khoản vay đến 500 triệu,
                  <br />
                  Thời hạn vay đến 90 ngày, <br />
                  kỳ thanh toán 10, 15 hoặc 30 ngày tùy chọn. APR = 20%. <br />
  ...
  return (
    <div className={"signin-form block-grey"}>
      <div className={"banner-image"}>
        <div className={"label"}>ĐĂNG KÝ VAY THEO ĐĂNG KÝ XE Ô TÔ</div>
      </div>
      <WhiteSpace size="lg" />
      <WingBlank size="lg">
        <div
...
export default CarRegistrationLoan;
