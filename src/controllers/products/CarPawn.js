...
class CarPawn extends BaseProduct {
  constructor(props) {
    super(props);

    this.state = {
      visit_source: lgd("visit_source", "mf24h"),
      form_product: "car_pawn",
...
function DLoanForm(props) {
  return (
    <div className={"block-grey desktop-loan-banner desktop-car-pawn-banner"}>
      <div
            ...
            >
              ...
              >
                ...
                <div css={{ color: "#939393", fontSize: "14px" }}>
                  MF24H tư vấn gói vay Cầm ô tô với khoản vay đến 1 tỷ.
                  <br />
                  Kỳ hạn vay 60 tháng, kỳ thanh toán 10, 15 hoặc 30 ngày KH tùy
                  chọn. <br />
                  <br />
  ...
  return (
    <div className={"signin-form block-grey"}>
      <div className={"banner-image"}>
        <div className={"label"}>ĐĂNG KÝ CẦM Ô TÔ</div>
      </div>
      <WhiteSpace size="lg" />
      <WingBlank size="lg">
        <div
        ...
        >
          ...
          >
            ...
            <div css={{ color: "#939393", fontSize: "14px" }}>
              MF24H tư vấn gói vay Cầm ô tô <br />
              với khoản vay đến 1 tỷ. <br />
              Kỳ hạn vay 60 tháng, <br />
