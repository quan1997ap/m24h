...
class HouseholdRegistrationLoan extends BaseProduct {
  constructor(props) {
    super(props);

    this.state = {
      visit_source: lgd("visit_source", "mf24h"),
      form_product: "household_registration_loan",
...
function DLoanForm(props) {
  return (
    <div
      className={
        "block-grey desktop-loan-banner desktop-household-registration-loan-banner"
      }
    >
      <div
            ...
            >
              ...
              >
                ...
                <div css={{ color: "#939393", fontSize: "14px" }}>
                  MF24H tư vấn gói vay theo sổ hộ khẩu, khoản vay đến 50 triệu.{" "}
                  <br />
  ...
  return (
    <div className={"signin-form block-grey"}>
      <div className={"banner-image"}>
        <div className={"label"}>ĐĂNG KÝ VAY THEO SỔ HỘ KHẨU</div>
      </div>
      <WhiteSpace size="lg" />
      <WingBlank size="lg">
        <div
        ...
        >
          ...
          >
            ...
            <div css={{ color: "#939393", fontSize: "14px" }}>
              MF24H tư vấn gói vay theo sổ hộ khẩu, <br />
              khoản vay đến 50 triệu. <br />
              Kỳ hạn thanh toán đến 90 ngày. <br />
              Kỳ thanh toán 10, 15 hoặc 30 ngày KH tùy chọn. <br />
              <strong>Chi tiết liên hệ {config.hotline}</strong>
            </div>
            <Flex>
              <Flex.Item>
...
export default HouseholdRegistrationLoan;
