...
class HouseMortageLoan extends BaseProduct {
  constructor(props) {
    super(props);

    this.state = {
      visit_source: lgd("visit_source", "mf24h"),
      form_product: "house_mortage_loan",
...
function DLoanForm(props) {
  return (
    <div
      className={
        "block-grey desktop-loan-banner desktop-house-mortage-loan-banner"
      }
    >
      <div
            ...
            >
              ...
              >
                ...
                <div css={{ color: "#939393", fontSize: "14px" }}>
                  MF24H cho phép trả góp gốc, lãi, phí theo kỳ hạn
                  15/30/60/90/120/150 ngày, <br />
                  kỳ thanh toán 15 hoặc 30 ngày tùy chọn.
                  <br />
  ...
  return (
    <div className={"signin-form block-grey"}>
      <div className={"banner-image"}>
        <div className={"label"}>ĐĂNG KÝ VAY THẾ CHẤP SỔ ĐỎ</div>
      </div>
      <WhiteSpace size="lg" />
      <WingBlank size="lg">
        <div
        ...
        >
          ...
          >
            ...
            <div css={{ color: "#939393", fontSize: "14px" }}>
              MF24H cho phép trả góp gốc, lãi, phí <br /> theo kỳ hạn
              15/30/60/90/120/150 ngày, <br />
              kỳ thanh toán 15 hoặc 30 ngày tùy chọn.
              <br />
              <strong>Chi tiết liên hệ {config.hotline}</strong>
...
export default HouseMortageLoan;
