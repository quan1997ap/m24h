...
class MotorbikePawn extends BaseProduct {
  constructor(props) {
    super(props);

    this.state = {
      visit_source: lgd("visit_source", "mf24h"),
      form_product: "motorbike_pawn",
...
function DLoanForm(props) {
  return (
    <div
      className={"block-grey desktop-loan-banner desktop-motorbike-pawn-banner"}
    >
      <div
            ...
            >
              ...
              >
                ...
                <div css={{ color: "#939393", fontSize: "14px" }}>
                  MF24H tư vấn gói vay Cầm Xe máy với khoản vay đến 30 triệu.{" "}
                  <br />
  ...
  return (
    <div className={"signin-form block-grey"}>
      <div className={"banner-image"}>
        <div className={"label"}>ĐĂNG KÝ CẦM XE MÁY</div>
      </div>
      <WhiteSpace size="lg" />
      <WingBlank size="lg">
        <div
        ...
        >
          ...
          >
            ...
            <div css={{ color: "#939393", fontSize: "14px" }}>
              MF24H tư vấn gói vay Cầm Xe máy <br />
              với khoản vay đến 30 triệu. <br />
